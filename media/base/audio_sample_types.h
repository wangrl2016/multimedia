...
namespace mm {
    ...
    private:
        ...
        struct ScalingFactors {
            // Since zero_point_value() is not the extra center between
        ...
        static SampleType From(FloatType source_value) {
            ...
            // handle the case of |source_value| == 1.0 as part of clipping check.
            // For all FloatType value smaller than 1.0, the imprecision of
