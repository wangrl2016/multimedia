...
int main(int argc, char* argv[]) {
    ...
    void* data = calloc(data_size, sizeof(uint8_t));
     ...
     */
    char* buffer = (char*) calloc(data_size, data_size + 44);
    ...
    // number.
    // 40 - 43
    auto Subchunk2Size = int32_t(data_size);
    ...
    ofs.write(buffer, int(data_size) + 44);
